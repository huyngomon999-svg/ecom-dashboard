...
import { Search, Download, ChevronUp, ChevronDown, ChevronLeft, ChevronRight as ChevronRightIcon } from "lucide-react";
...
function exportCSV(data: typeof allOrders) {
...
export default function OrdersPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return data;
  }, [dateRange, channels, statusFilter, search, sortKey, sortDir]);
                ...
                {paged.length === 0 ? (
                  ...
                  <tr key={o.id} className="border-b border-[var(--color-border)] last:border-0 hover:bg-[var(--color-surface-2)] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="text-[10px] text-[var(--color-text-muted)]">{o.customerPhone}</div>
                    </td>
